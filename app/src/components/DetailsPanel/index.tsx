      ...
      case 1:
        return (
          <>
            ...
            {renderModifier('Number of shots', calculatePercentage(selectedGotchi?.withSetsNumericTraits[i] as number))}
          </>
        );
      case 2:
        return (
          <>
            ...
            {renderModifier('Number of sushibombs', calculatePercentage(selectedGotchi?.withSetsNumericTraits[i] as number))}
          </>
        );
      case 3:
        return (
          <>
            ...
            {renderModifier('Number of GHSTs', calculatePercentage(selectedGotchi?.withSetsNumericTraits[i] as number))}
          </>
        );
      default:
    }
